...
export function FailureModeDetails({ id }: FailureModeDetailsProps) {
  ...
  const handleBack = () => {
    if (isInTechnicianRoute) {
      router.push("/technician/failure-mode");
    } else {
      router.push("/failure-mode");
    }
  };
      ...
      <div className="mx-auto max-w-4xl">
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            {/* Reporter Section */}
            <div className="space-y-2">
              <h2 className="text-lg font-semibold">Reported By</h2>
